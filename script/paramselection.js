...
function newpchem()
{
  var arr = ['Odor', 'Taste', 'Color(Apparent)', 'Turbidity', 'pH  @ 25 ºC',
...
function oldLag()
{
  var arr = ['Odor', 'Taste', 'Color(Apparent)', 'Turbidity', 'pH  @ 25 ºC', 'Chlorides', 
...
function dialysis()
{
  var arr = ['Aluminum', 'Arsenic', 'Barium', 'Cadmium', 'Calcium', 'Chloramines', 
              'Chlorine(Residual)', 'Chromium', 'Total', 'Copper as Dissolved', 'Fluoride', 
              'Lead', 'Magnesium', 'Mercury', 'Nitrate(as NO3-Nitrogen)', 'Potassium', 
